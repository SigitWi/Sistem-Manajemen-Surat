...
class Home extends CI_Controller
{
    ...
    public function index()
    {
        if ($this->session->userdata('logged_in') == true) {
            ...
            } else if ($this->session->userdata('nama_jabatan') == 'Lurah') {
                $data['judul'] = 'Selamat datang, ' . $this->session->userdata('nama_pegawai') . '!';
                $data['jumlah_surat'] = $this->HomeModel->get_jumlah_surat();
                $data['main_view'] = 'lurah/dashboard';
                $this->load->view('template', $data);
            } else {
                $data['judul'] = 'Selamat datang, ' . $this->session->userdata('nama_pegawai') . '!';
                $data['jumlah_disposisi'] = $this->HomeModel->get_jumlah_disposisi();
                $data['main_view'] = 'kasie/dashboard';
                $this->load->view('template', $data);
            }
        } else {
            redirect('login');
    ...
    public function surat_masuk()
    {
        if ($this->session->userdata('logged_in') == true) {
            if ($this->session->userdata('nama_jabatan') == 'Sekretaris') {
                ...
                $data['judul'] = 'Surat Masuk';
                $data['main_view'] = 'lurah/surat_masuk';
                $data['data_surat_masuk'] = $this->HomeModel->get_surat_masuk();
                $this->load->view('template', $data);
            } else {
                redirect('logout');
    ...
    public function surat_keluar()
    {
        if ($this->session->userdata('logged_in') == true) {
            if ($this->session->userdata('nama_jabatan') == 'Sekretaris') {
                ...
                $data['judul'] = 'Surat Keluar';
                $data['main_view'] = 'lurah/surat_keluar';
                $data['data_surat_keluar'] = $this->HomeModel->get_surat_keluar();
                $this->load->view('template', $data);
            } else {
                redirect('logout');
    ...
    {
        if ($this->session->userdata('logged_in') == true) {
            if ($this->session->userdata('nama_jabatan') == 'Lurah') {
    ...
    public function disposisi($id_surat)
    {
        if ($this->session->userdata('logged_in') == true) {
            if ($this->session->userdata('nama_jabatan') == 'Lurah') {
                ...
                $data['main_view'] = 'lurah/disposisi';
    ...
    public function disposisi_keluar()
    {
        if ($this->session->userdata('logged_in') == true) {
            ...
            $data['main_view'] = 'kasie/disposisi_keluar';
    ...
    public function disposisi_masuk()
    {
        if ($this->session->userdata('logged_in') == true) {
            ...
            $data['main_view'] = 'kasie/disposisi_masuk';
            $data['disposisi_masuk'] = $this->HomeModel->get_disposisi_masuk($this->session->userdata('id_pegawai'));
            // print_r($data);
            // exit;
            $this->load->view('template', $data);
        } else {
